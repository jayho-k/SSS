...
check : ../file/latest.pth
det-con : ../file/faster_rcnn_r50_fpn_2x_coco.py
def-check: ../file/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15.pth
label : ../file/label_map.txt
...
def frame_extraction(video_path):
    ...
    target_dir = osp.join('../videos/tmp', osp.basename(osp.splitext(video_path)[0]))
...
def run(**kwargs):
    ...
    print(args)
    print(type(print(args.predict_stepsize)),args.predict_stepsize)
    ...
    print(osp.dirname(frame_paths[0]))
